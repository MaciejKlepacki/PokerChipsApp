...
const creatingBoxes = function (x) {
  ...
  for (let i = 0; i <= x; i++) {
    ...
    <input class="raise-input" id="raise-input-${i}" type="number" placeholder="Raise"/>
...
const opacity0 = w => (boxIndex[w].style.opacity = 0);
...
// All blind button
blindAllIndex.addEventListener('click', function () {
